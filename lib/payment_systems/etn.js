    ...
    global.support.rpcWallet(transferFunc, paymentDetails, function (body) {
        ...
        if (paymentDetails.hasOwnProperty('payment_id')) {
            ...
            if (transferFunc === 'transfer') {
                console.log("Payment made out to multiple people, total fee: " + global.support.coinToDecimal(body.result.fee) + " ETN");
            }
            let intCount = 0;
            paymentDetails.destinations.forEach(function (details) {
                console.log("Payment made to: " + details.address + " For: " + global.support.coinToDecimal(details.amount) + " ETN");
                intCount += 1;
...
function Payee(amount, address, paymentID, bitcoin) {
    ...
    this.setFeeAmount = function () {
        ...
        console.log(`\n`);
        console.log(`_______________________________________ Вызван setFeeAmount`);
    ...
    this.makePaymentWithID = function () {
        ...
        console.log(`\n`);
        console.log(`_______________________________________ Вызван makePaymentWithID; Payment Details:`);
    ...
    this.makePaymentAsIntegrated = function () {
        ...
        console.log(`\n`);
        console.log(`_______________________________________ Вызван makePaymentAsIntegrated; Payment Details:`);
        console.log(JSON.stringify(paymentDetails));
        console.log(`this.address`);
        console.log(this.address);
        console.log(`this.fee`);
    ...
    this.makeBitcoinPayment = function () {
        ...
        console.log(`\n`);
        console.log(`_______________________________________ Вызван makeBitcoinPayment;`);
    ...
    this.trackPayment = function () {
        ...
        console.log(`\n`);
        console.log(`_______________________________________ Вызван trackPayment`);
        console.log(`this.amount`);
        console.log(this.amount);
    ...
    console.log(`\n`);
    console.log(`_______________________________________ Создан обьект для выплат => Payee`);
    console.log(this);
    ...
    global.mysql.query("SELECT * FROM balance WHERE amount >= ?", [global.support.decimalToCoin(global.config.payout.walletMin)]).then(function (rows) {
        ...
        rows.forEach(function (row) {
            ...
            global.mysql.query("SELECT payout_threshold FROM users WHERE username = ?", [payee.id]).then(function (userRow) {
                ...
                console.log(`\n`);
                console.log(`_______________________________________ Вызван makePayments`);
                console.log(`threshold`);
                console.log(threshold);
                console.log(`payee.poolType`);
                console.log(payee.poolType);
                console.log(`payee.address`);
                console.log(payee.address);
                console.log(`global.config.payout.feeAddress`);
                console.log(global.config.payout.feeAddress);
                ...
                if (payee.poolType === "fees" && payee.address === global.config.payout.feeAddress && payee.amount >= ((global.support.decimalToCoin(global.config.payout.feesForTXN) + global.support.decimalToCoin(global.config.payout.exchangeMin)))) {
                    console.log("This is the fee address internal check for value");
                    ...
                    console.log("Unable to pay fee address.");
                    payee.amount = 0;
                }
                ...
                if (payee.amount > threshold) {
                    ...
                    if (payee.bitcoin === 0 && payee.paymentID === null && payee.amount !== 0 && payee.amount > 0 && payee.address.length !== 106) {
                        ...
                        console.log("Adding " + payee.id + " to the list of people to pay (Integrated Address).  Payee balance: " + global.support.coinToDecimal(payee.amount));
                        ...
                        console.log("Adding " + payee.id + " to the list of people to pay (Payment ID Address).  Payee balance: " + global.support.coinToDecimal(payee.amount));
                        ...
                        console.log("Adding " + payee.id + " to the list of people to pay (Bitcoin Payout).  Payee balance: " + global.support.coinToDecimal(payee.amount));
                        ...
                        paymentQueue.push(paymentDetails, function (body) {  //jshint ignore:line
                            ...
                            if (body.fee && body.fee > 0.0000001) {
                                ...
                                paymentDetails.destinations.forEach(function (payeeItem) {
                                    console.log("payeeObjects[payeeItem.address].amount");
                                    console.log(payeeObjects[payeeItem.address].amount);
                                    console.log("payeeObjects[payeeItem.address].fee");
                                    console.log(payeeObjects[payeeItem.address].fee);
